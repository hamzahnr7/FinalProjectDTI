...
function CashlessPayment() {
  ...
  return (
    <View style= {{flex:1, backgroundColor: '#FFF1E1'}}>
      ...
      <TouchableOpacity style={{width: 250, height: 250, borderRadius: 10, marginTop: 80, backgroundColor: '#FFC8AF', alignSelf: 'center'}} 
      onPress={() => navigation.navigate('CashlessSuccess')}></TouchableOpacity>
